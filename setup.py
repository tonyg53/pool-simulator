...
class Setup(object):
    ...
    def SetupSim(self):
        ...
        print(math.degrees(brakeAzmuth))
...
def Rack(numBalls, table):
    ...
    if len(ballList) == 7:
        ...
        imperfection = random.random() * 5
        if not pos:
            imperfection *= -1
        # print(imperfection, pos)
        ballList[0].Loc.x = table.length / 5
        ballList[0].Loc.y = table.width * 7 / 8
        ballList[1].Loc.x = table.length * 3 / 4
        ballList[1].Loc.y = table.width / 2
        ballList[2].Loc.x = ballList[1].Loc.x + math.cos(math.radians(60 + imperfection)) * ballList[1].radius
        ballList[2].Loc.y = ballList[1].Loc.y + math.sin(math.radians(60 + imperfection)) * ballList[1].radius
        ballList[3].Loc.x = ballList[1].Loc.x + math.cos(math.radians(60 + imperfection)) * ballList[1].radius
        ballList[3].Loc.y = ballList[1].Loc.y - math.sin(math.radians(60 + imperfection)) * ballList[1].radius
        ballList[4].Loc.x = ballList[2].Loc.x + math.cos(math.radians(60 + imperfection)) * ballList[2].radius
        ballList[4].Loc.y = ballList[2].Loc.y + math.sin(math.radians(60 + imperfection)) * ballList[2].radius
        ballList[5].Loc.x = ballList[2].Loc.x + math.cos(math.radians(60 + imperfection)) * ballList[2].radius
        ballList[5].Loc.y = ballList[2].Loc.y - math.sin(math.radians(60 + imperfection)) * ballList[2].radius
        ballList[6].Loc.x = ballList[3].Loc.x + math.cos(math.radians(60 + imperfection)) * ballList[3].radius
        ballList[6].Loc.y = ballList[3].Loc.y - math.sin(math.radians(60 + imperfection)) * ballList[3].radius
